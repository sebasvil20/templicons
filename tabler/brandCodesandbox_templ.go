...
func BrandCodesandbox(props ...i.Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<path d=\"M20 7.5v9l-4 2.25l-4 2.25l-4 -2.25l-4 -2.25v-9l4 -2.25l4 -2.25l4 2.25z\"></path> <path d=\"M12 12l4 -2.25l4 -2.25\"></path> <path d=\"M12 12l0 9\"></path> <path d=\"M12 12l-4 -2.25l-4 -2.25\"></path> <path d=\"M20 12l-4 2v4.75\"></path> <path d=\"M4 12l4 2l0 4.75\"></path> <path d=\"M8 5.25l4 2.25l4 -2.25\"></path>")
			if templ_7745c5c3_Err != nil {
